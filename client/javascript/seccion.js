    ...
    if (path === "/" || path === "/galeria") {
        ...
        fetch('')
            ...
            .then(data => {
                ...
                contenido.innerHTML = `
                <!-- welcome header -->
                <div class="bg-image" style="background-image: url(client/static/img/baner-bocatto.png);"></div>
                <nav class="bg-text">
                ...
                <article id="principal" class="w3-main w3-content w3-padding" style="max-width: 1200px">
                    ...
                    <section class="w3-row w3-padding-top w3-white" id="descripcion">
                        <div class="w3-half w3-padding-large w3-hide-small">
                            <br />
                            <img src="client/static/img/mila-1.JPG" class="w3-round w3-image" alt="Table"
                                style="width: 100%" />
                        </div>
                    ...
                    <section class="w3-row w3-padding-top w3-white" id="descripcion">
                        ...
                        <div class="w3-half w3-padding-large w3-hide-small">
                            <br />
                            <br />
                            <img src="client/static/img/arrollado.JPG" class="w3-round w3-image" alt="Table"
                        ...
                        <div id="demo" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="client/static/img/work-1.jpg" alt="Los Angeles" class="d-block" style="width:100%" />
                                </div>
                                <div class="carousel-item">
                                    <img src="client/static/img/work-2.jpg" alt="Chicago" class="d-block" style="width:100%" />
                                </div>
                                <div class="carousel-item">
                                    <img src="client/static/img/work-3.jpg" alt="New York" class="d-block" style="width:100%" />
                                </div>
                            </div>
                    ...
                    <section style="height: 900px" id="galeria">
                        ...
                        <div class="w3-row-padding w3-padding-16 w3-center w3-display-container">
                            ...
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/pollo-1.JPG" alt="Pollo" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/pata-1.JPG" alt="Pata de pollo" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/mila-papa.JPG" alt="Milanesa" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/arrollado-2.JPG" alt="Arrollado" />
                            </div>
                        </div>
                        <!-- Sequend Grid Photo Grid Alfajor -->
                        <div class="w3-row-padding w3-padding-16 w3-center w3-display-container">
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/mila-1.JPG" alt="Alfajor Negro" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/mila.elaboracion-4.jpg" alt="Alfajor Blanco" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/arrollado-3.jpg" alt="Alfajor Blanco" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/pechuga-1.JPG" alt="Alfajor Blanco" />
                            </div>
                        </div>
                        <!-- Three Grid Photo Grid Alfajor -->
                        <div class="w3-row-padding w3-padding-16 w3-center w3-display-container">
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/burger-1.jpg" alt="Alfajor Negro" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/Mila-elaboracion-1.JPG" alt="Alfajor Blanco" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/mila-3.JPG" alt="Alfajor Blanco" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/mila-4.JPG" class="crop" alt="Alfajor Blanco" />
                            </div>
                        </div>
                        <!-- Four Grid Photo Grid Alfajor -->
                        <div class="w3-row-padding w3-padding-16 w3-center w3-display-container">
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/pata.muslo-3.jpg" alt="Alfajor Negro" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/albondiga-2.jpg" alt="Alfajor Blanco" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/pollo-2.JPG" alt="Alfajor Blanco" />
                            </div>
                            <div class="w3-quarter contenedor-img">
                                <img src="client/static/img/pechuga-5.jpg" class="crop" alt="Alfajor Blanco" />
                            </div>
                        </div>
                    </section>
                </article>
